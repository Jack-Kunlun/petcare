...
describe("WechatAuthService", () => {
  ...
  beforeEach(() => {
    ...
    wechatApiClient.getPhoneNumber.mockResolvedValue("17679141878");
  ...
  it("creates a pet owner for a new authorized phone", async () => {
    await expect(service.bindPhone("bind-token", "phone-code")).resolves.toMatchObject({
      accessToken: "access",
      user: { phone: "17679141878", nickname: "宠友1878" },
    });
  ...
  it("binds an unbound existing phone account without replacing its data or roles", async () => {
    ...
    usersByPhone["17679141878"] = existingPhoneUser as typeof activeUser;
  ...
  it.each([
    ...
    usersByPhone["17679141878"] = phoneUser;
  ...
  it("rejects disabled accounts", async () => {
    usersByPhone["17679141878"] = { ...activeUser, status: "banned" };
