...
const auth: AuthContextValue = {
  status: "authenticated", user: { id: "admin-1", username: "operator", phone: "17679141878", nickname: "运营管理员", avatar: null, roles: ["operator"], permissions: ["website.view", "website.publish"] },
