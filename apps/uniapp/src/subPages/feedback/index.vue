...
function getToastPositionLabel(position: "top" | "middle" | "bottom") {
  if (position === "top") {
    return "顶部";
  }
...
function demoToastPosition(position: "top" | "middle" | "bottom") {
  showToast({
    msg: `显示在${getToastPositionLabel(position)}的提示`,
    position,
    duration: 2000,
  });
}
      ...
      <view class="space-y-3">
        <view class="rounded-2 p-4 wot-bg-filled-oppo">
          ...
          <view class="text-3 leading-relaxed wot-text-text-secondary space-y-2">
            ...
            <view>
              •
              <text class="text-purple-600 font-bold dark:text-purple-400"> 类型安全 </text>：完整的
              TypeScript 类型定义
            </view>
            <view>
              •
              <text class="text-orange-600 font-bold dark:text-orange-400"> 易于使用 </text>：简洁的
              API 设计，开箱即用
            </view>
          </view>
        </view>
