...
export const RBAC_PERMISSION_CATALOG: readonly RbacPermissionDefinition[] = [
  ...
  {
    code: "payment.operations.review",
    type: "button",
    label: "记录日账差异处理",
    module: "payment",
    path: null,
    parentCode: "payment.operations.view",
    order: 10,
    icon: null,
    impliedApiCodes: ["payment.bill_review"],
  },
  {
    code: "payment.operations.run",
    type: "button",
    label: "发起日账核对",
    module: "payment",
    path: null,
    ...
    order: 20,
    icon: null,
    impliedApiCodes: ["payment.bill_action"],
  },
  {
