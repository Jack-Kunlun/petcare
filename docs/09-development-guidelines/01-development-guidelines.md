...
- **项目名称**：PetCare宠伴
- **当前定位**：已交付个人版基线，按路线图分阶段恢复 C2C 服务工程能力
- **当前主线**：账户、宠物档案、内容社区，以及默认关闭的 Cycle 5 悬赏纵向链路
- **暂停范围**：资质外部接入、真实资金、B2C 和 Cycle 5–7 以外的商业能力

当前任务以[开发路线图](../01-requirements/05-development-roadmap.md)为准，范围落实与历史商业代码处理遵循[个人基线与商业能力分阶段恢复规范](./06-personal-scope-and-code-cleanup.md)。本文只提供研发流程概览；技术栈、分支、命令或路径与根目录 `AGENTS.md`、实际仓库配置冲突时，以当前仓库为准。
