...
SOP 校验五步连续、名称 2–20、说明 10–500、时长 1–240、照片 0–20、违规规则完整、重复内容和总时长；评分校验窗口 5–100、样本不超过窗口、分数 100–500、暂停严格低于警告、培训说明非空；费率校验中平台抽成为 0–5000 万分比、提现手续费为 0–1000 万分比，金额为非负整数。
