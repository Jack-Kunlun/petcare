...
| 文档                                                                                    | 说明                                         | 适合人群      |
| --------------------------------------------------------------------------------------- | -------------------------------------------- | ------------- |
| [01-database-schema.md](./05-database-design/01-database-schema.md)                     | 历史完整方案的数据字典与关系设计             | 后端开发、DBA |
| [02-personal-scope-data-audit.md](./05-database-design/02-personal-scope-data-audit.md) | 个人版模型消费者、真实本地数据及迁移审批门禁 | 后端开发、DBA |
